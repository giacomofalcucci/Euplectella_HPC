...
set output 'Cylinder_Attractor_REV.eps'
unset clip points
set clip one
unset clip two
...
set xtics 0.04
#set xtics ("0" 0, "4" 0.0457, "8" 0.0914, "13" 0.149)
set xtics ("0" 0, "6.5" 0.0745, "13" 0.149)
set ytics border in scale 1,0.5 mirror norotate  autojustify
set ytics  norangelimit autofreq 
set ytics 0.075
#set ytics ("-12" -0.148, "-6" -0.0686, "0" 0, "6" 0.0686, "12" 0.148)
set ytics ("-13" -0.149, "0" 0, "13" 0.149)
...
set xlabel "{/Helvetica-Oblique u_x}" 
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ 0.00000 : 0.149000 ] noreverse writeback
set x2range [ * : * ] noreverse writeback
set ylabel "{/Helvetica-Oblique u_y}" offset -1.5,0,0
set ylabel  font "" textcolor lt -1 rotate
set y2label "" 
set y2label  font "" textcolor lt -1 rotate
set yrange [-0.149:0.149] noreverse writeback
...
splot 'probe_g.0056_Re_100.dat' u 2:3:6 pt 15 title 'Re = 100', 'probe_g.0056_Re_500.dat' u 2:3:6 pt 13 title 'Re = 500', 'probe_g.0056_Re_1000.dat' u 2:3:6 title 'Re = 1000' lc 7 pt 7, 'probe_g.0056_Re_1500.dat' u 2:3:6 title 'Re = 1500' lc 6 pt 9, 'probe_g.0056_Re_2000.dat' u 2:3:6 lc 4 title 'Re = 2000'
#    EOF
