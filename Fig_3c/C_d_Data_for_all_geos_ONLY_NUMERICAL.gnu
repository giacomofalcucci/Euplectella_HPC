...
set terminal postscript landscape enhanced defaultplex \
   ...
   "Helvetica" 23  fontscale 1.0 
set output 'C_d_Data_for_all_geos_NUMERICAL_w_EB.eps'
unset clip points
set clip one
unset clip two
...
set key box vertical width -3 height 0.2 maxcols 1 spacing 1.05
set pointsize 1.5
...
plot 'Kawamura_1986.csv' u 1:2 w p pt 8 lc rgb '#f800a7' lw 3 title 'Kawamura, 1986', 'Henderson_data_from_Sahin.csv' u 1:2 w p pt 14 lc 3 lw 3 title 'Henderson, 1995', 'Posdziech_Grundmann_data_from_Shain.csv' u 1:2 w p pt 16 lw 2 lc rgb '#404040' title 'Posdziech and Grundmann, 2001', 'Shain_data.csv' u 1:2 w p pt 10 lc 7 lw 3 title 'Sahin and Owens, 2004', 'Fujisawa_2005.csv' u 1:2 w p pt 4 lc rgb '#ff8400' lw 3 title 'Fujisawa, 2005', 'Hanchi_1999.csv' u 1:2 w p pt 12 lw 3 lc 1 title 'Hanchi, 1999', 'C_d_Data_for_all_geos.dat' u 1:2 w p pt 7 lc 7 title 'LBM - S 1', 'C_d_Data_for_all_geos.dat' u 1:3 w p pt 5 lc rgb '#1e00ff' title 'LBM - S 2', 'C_d_Data_for_all_geos.dat' u 1:4 w p pt 13 lc 4 ps 1.6 title 'LBM - P 1', 'C_d_Data_for_all_geos.dat' u 1:5 w p pt 15 lc rgb '#009019' ps 1.6 title 'LBM - P 2', 'C_d_Data_for_all_geos.dat' u 1:5:6:7 w yerrorbars pt 15 lc rgb '#009019' ps 1.6 title '', 'C_d_Data_for_all_geos.dat' u 1:2 w p pt 7 lc 7 title '', 'C_d_Data_for_all_geos.dat' u 1:2 w p pt 6 lc 8 lw 1 title ''
#    EOF
