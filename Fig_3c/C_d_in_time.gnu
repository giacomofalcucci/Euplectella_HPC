...
set yrange [ 0.8: 2] noreverse nowriteback
...
GNUTERM = "x11"
set grid
p 'CILINDRO/RUN_64GPU_R2000/DRAG/drag.delta67.dat' u 0:($3/(0.5*0.1*0.1*(2*(100+67)*400))) w l lw 4 t "Cylinder (S1)", 'CILINDRO-COSTOLE/RUN_64GPU_CYL_2000/DRAG/drag.delta67.dat' u 0:($3/(0.5*0.1*0.1*(1*(100+67)*340))) w l lw 4 lc 3 t "Cylinder with Ridges (S2)"
#    EOF
