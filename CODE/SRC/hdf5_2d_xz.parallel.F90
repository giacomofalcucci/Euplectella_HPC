...
!=======================================================================
!
      subroutine hdf5_2d_xz_parallel(itime)
!
      use storage
#ifdef SERIAL
! noting to include
...
!
      implicit none
!
      character(len=20) :: file_name="u_xz_XXX_XXXXXXXX.h5"
...
!
      ...
      enddo
!
      write(file_name(6:8),3000) j0 ! to fix!!!!!!
...
#ifdef DEBUG_1
        if(myrank == 0) then
           write(6,*) "DEBUG1: Exiting from sub. hdf5_2d_xz_parallel"
        endif
#endif
!
3000  format(i3.3)
4000  format(i8.8)
      ...
      return
      end subroutine hdf5_2d_xz_parallel
