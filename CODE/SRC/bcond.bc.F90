...
!$acc loop independent
          do j = 1, m
             ...
             a05(0,j,0) = a05(0,j,1)
!
             a01(0,j,n1) = a01(0,j,n)
             a02(0,j,n1) = a02(0,j,n)
             a03(0,j,n1) = a03(0,j,n)
             a04(0,j,n1) = a04(0,j,n)
             a05(0,j,n1) = a05(0,j,n)
          enddo
!$acc end kernels
!
!$acc kernels
!$acc loop independent
          do k = 1, n
             ...
             a05(0,0,k) = a05(0,1,k)
!
             a01(0,m1,k) = a01(0,m,k)
             a02(0,m1,k) = a02(0,m,k)
             a03(0,m1,k) = a03(0,m,k)
             a04(0,m1,k) = a04(0,m,k)
             a05(0,m1,k) = a05(0,m,k)
          enddo
!$acc end kernels
#endif
        endif
