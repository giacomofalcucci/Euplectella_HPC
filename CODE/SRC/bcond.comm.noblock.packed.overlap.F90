!=====================================================================
!     ****** LBE/bcond_comm_noblock_packed_overlap
!
!     COPYRIGHT
!       (c) 2000-2011 by CASPUR/G.Amati
!       (c) 2013-20?? by CINECA/G.Amati
!     NAME
!       bcond_comm_noblock_packed_overlap
!     DESCRIPTION
!       
!     INPUTS
!       none
...
!=====================================================================
!
        subroutine bcond_comm_noblock_packed_overlap
!
        use timing
        use storage
#ifdef SERIAL
...
#ifdef DEBUG_2
        if(myrank == 0) then
           write(6,*) "DEBUG2: Exiting from sub. bcond_comm_noblock_packed_overlap"
        endif
#endif
!
        return
        end subroutine bcond_comm_noblock_packed_overlap
