...
# else
#  ifdef HALF_P
        real(sp) :: x01,x02,x03,x04,x05,x06,x07,x08,x09,x10
        real(sp) :: x11,x12,x13,x14,x15,x16,x17,x18,x19
        real(sp) :: e01,e02,e03,e04,e05,e06,e07,e08,e09,e10
        real(sp) :: e11,e12,e13,e14,e15,e16,e17,e18,e19
        real(sp) :: rho,rhoinv,vx,vy,vz,vx2,vy2,vz2,vsq
        real(sp) :: vxpy,vxmy,vxpz,vxmz,vypz,vymz,rp1,rp2
        real(sp) :: qxpy,qxmy,qxpz,qxmz,qypz,qymz,qx,qy,qz
        real(sp) :: forcex, forcey, forcez
        real(sp) :: pi
#  else
...
!$OMP DO
#ifdef NOMANAGED
!$acc data present(a01,a02,a03,a04,a05,a06,a07, &
!$acc              a08,a09,a10,a11,a12,a13,a14, & 
!$acc              a15,a16,a17,a18,a19,b01,b02, & 
!$acc              b03,b04,b05,b06,b07,b08,b09, & 
!$acc              b10,b11,b12,b13,b14,b15,b16, & 
!$acc              b17,b18)
#endif
!$acc kernels  
